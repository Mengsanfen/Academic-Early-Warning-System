    ...
    <div class="import-content">
      ...
      <div v-show="currentStep === 0" class="upload-section">
        <div class="template-download">
          <span>请先下载导入模板，按照模板格式填写成绩数据</span>
        ...
        <div class="import-options">
          <el-form label-width="120px">
            <el-form-item label="更新已存在记录">
              ...
              <span class="option-hint">开启后将更新已存在的成绩记录</span>
            </el-form-item>
          </el-form>
        </div>
      </div>
...
import { downloadScoreTemplate, importScores } from '@/api/import'
...
const handleImport = async () => {
  ...
  try {
    const result = await importScores(selectedFile.value, updateExisting.value)
